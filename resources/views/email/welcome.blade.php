...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <title>Welcome to Ropstam </title>
      <style type="text/css">
                                          ...
                                          <tr>
                                             ...
                                             <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                <div style="line-height: 24px">
                                                 ...
                                                 Log into your application and <a href="{{ route('login') }}">make your first car onboarding experience</a> <br>
                                                 Email : <strong> {{ $user->email }} </strong> <br/>  Your Password : <strong>  {{ $password }} </strong> <hr/>
                                                ...
                                                <tr>
                                                   <td>
                                                      <div>
                                                         ...
                                                         <![endif]-->
                                                         <a href="{{ route('login') }}" style="background-color:#80c97a;border:1px solid #80c97a;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Get started &rarr;</a>
                                                      </div>
                                                   </td>
                                                </tr>
                                             </table>
